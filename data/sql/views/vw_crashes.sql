...
SELECT
    ...
    doti.priority_geo as priority_geo,
    ...
    cdot.tu_1_nm_age as cdot_tu_1_nm_age,
    cdot.tu_1_nm_sex as cdot_tu_1_nm_sex,
    ...
    cdot.tu_2_nm_age as cdot_tu_2_nm_age,
    cdot.tu_2_nm_sex as cdot_tu_2_nm_sex
FROM vision_zero.incidents_denver doti
    LEFT JOIN vision_zero.cdot_crashes cdot
        ON ST_DWithin(cdot.geo, doti.geo, 200) -- meters
